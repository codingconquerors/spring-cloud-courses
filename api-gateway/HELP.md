...
* The original package name 'com.cloud.spring.microservices.api-gateway' is invalid and this project uses 'com.cloud.spring.microservices.apigateway' instead.

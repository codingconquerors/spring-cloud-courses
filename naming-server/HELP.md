...
* The original package name 'com.cloud.spring.microservices.naming-server' is invalid and this project uses 'com.cloud.spring.microservices.namingserver' instead.

...
* The original package name 'com.cloud.spring.microservices.spring-cloud-config-server' is invalid and this project uses 'com.cloud.spring.microservices.springcloudconfigserver' instead.
